...
class AuthMonitor:
    ...
    def __init__(self, base_interval_minutes: int = 1, max_iterations: Optional[int] = None):
    ...
    async def run_monitor(self):
        ...
        logging.info(f"Starting auth monitor with base interval: {self.base_interval//60} minutes")
...
async def main():
    ...
    parser.add_argument(
        ...
        type=int, 
        default=1, 
        help="Base interval in minutes (default: 1)"
    )
    parser.add_argument(
        "--max-iterations", 
        type=int, 
